...
| 4 – Capability-Modell | **TEILWEISE; Vokabular steht** | CapabilityDescriptorV1, CapabilityResultV1 mit strukturiertem Fehler, SchemaRef mit Herkunft und Hash, stabile Capability-Ids und der LegacyCapabilityAdapter sind gebaut und ueber GET /api/v1/capabilities angeschlossen. Query/Mutation/Resource/Prompt/Task sind anbietbar; Event, Subscription und AgentDelegation bleiben gesperrt (EventV1 vertagt, A2A offen). Offen: die Migration des Invocation-Pfads auf CapabilityResultV1 sowie Artifacts und Pagination. |
