...
| [0015](./0015-protokollneutrales-capability-modell.md) | Protokollneutrales Capability-Modell — Vokabular umgesetzt, Invocation-Migration offen | Vorgeschlagen | 2026-07-24 | — |
| [0016](./0016-versionierter-connector-plugin-vertrag.md) | Versionierter Connector-/Plugin-Vertrag — Laufzeit und Pakete umgesetzt (nur WASI-Transport) | Akzeptiert | 2026-07-24 | — |
...
| [0018](./0018-native-prozess-und-container-isolation.md) | Native Prozess- und Container-Isolation — CLI-Container umgesetzt, Netz-Allowlist und stdio offen | Vorgeschlagen | 2026-07-24 | — |
...
| [0021-EM](./0021-entscheidungsmaterial-skills-im-paket.md) | Entscheidungsmaterial: Skills im Paket — Option B gebaut, die fünf Fragen sind Annahmen und nicht entschieden | Material | 2026-07-28 | Grundlage für eine Ergänzung zu [0016](./0016-versionierter-connector-plugin-vertrag.md) |
