...
/// <c>BIFROST_WASI_HOST</c> zeigt direkt auf das Binary, sonst wird
...
/// Gate nicht reißen. <c>BIFROST_REQUIRE_WASI_HOST=1</c> (im Rust-fähigen CI-Job gesetzt) macht aus
