...
internal static class ApprovalElicitation
{
    ...
    /// </summary>
    private const string StatePurpose = "McpMcp.Server.ApprovalElicitation.RequestState.v1";
    ...
    private static ILogger? Logger(IServiceProvider services)
        => services.GetService<ILoggerFactory>()?.CreateLogger("McpMcp.Server.ApprovalElicitation");
