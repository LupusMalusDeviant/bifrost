...
public sealed class EfAssetStore : IAssetStore
{
    ...
    public EfAssetStore(IDbContextFactory<BifrostDbContext> factory, TimeProvider? timeProvider = null)
    {
    ...
    private static async Task<List<Guid>> IdsFromPackageAsync(
        BifrostDbContext db, string packageId, CancellationToken ct)
    ...
    private static async Task EnsureNameFreeAsync(BifrostDbContext db, string name, CancellationToken ct)
    {
